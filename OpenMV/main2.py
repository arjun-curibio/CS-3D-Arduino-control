    ...
    while True:
        ...
        if isInit[current_well]:
            ...
            if len(tracker.stats_m) > 0:
                ...
                thresh = int(s.max()*tracker.smudgeFactor)
                ...
                print("{} area = {} centroid_m = {} extent = {} aspectratio = {} thresh = {}".format(tic, area, cent_m, extent, aspectratio, thresh))
            
            
            else:
                foundMagnet = False
                print("{} area = {} centroid_m = {} extent = {} aspectratio = {} thresh = {}".format(tic, area, cent_m, extent, aspectratio, tracker.thresh_range[0][1]))
